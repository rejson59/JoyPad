...
export default function JoypadApp() {
  ...
  useEffect(() => {
    ...
    padHost.onGameChoice = (index) => { setFocus(index); open(GAMES[index].id); };
  ...
  if (selected) return selected === 'tanks'
      ...
      <div className="relative mx-auto max-w-[1480px] px-4 pb-16 sm:px-7 lg:px-10">
        ...
        <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_330px]">
          <main className="min-w-0">
            ...
            <p className="mt-4 text-xs text-slate-500">Sterowanie menu: <kbd>←</kbd> <kbd>→</kbd> i <kbd>Enter</kbd> na klawiaturze lub pilot administratora na telefonie. Wybór gry: kliknij „Otwórz grę”.</p>
          </main>
