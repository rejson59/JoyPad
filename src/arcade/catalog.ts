...
export const GAMES: GameInfo[] = [
  ...
  },
  {
    ...
    features: ['Czujni strażnicy', 'Pułapki', 'Wspólna ucieczka'], renderTag: '3D LITE',
  },
  {
    ...
    teaser: 'Klocki • Surowce • Baza', cover: 'images/voxel-frontier.webp', accent: '#ff9a52', accentSoft: '#8a421c',
  ...
  },
  {
    ...
    teaser: 'Samochody • Boost • Bramki', cover: 'images/turbo-league.webp', accent: '#ff9a52', accentSoft: '#8a421c',
