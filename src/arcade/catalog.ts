...
export const GAMES: GameInfo[] = [
  ...
  },
  {
    ...
    features: ['Drift fizyka', 'Mokry tor', 'Turbo'], renderTag: '2D+',
  },
  {
    ...
    features: ['Fale wrogów', 'Asteroidy', 'Co-op'], renderTag: '2D+',
  },
  {
    ...
    features: ['Arena versus', 'Sprint', 'Power-upy'], renderTag: '2D+',
  },
  {
    ...
    features: ['BFS strażników', 'Pułapki', 'Wspólna ucieczka'], renderTag: '2D+',
  },
  {
