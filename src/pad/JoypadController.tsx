    ...
    <div className={`rounded-2xl border border-orange-400/20 bg-orange-500/[.07] ${compact ? 'p-3' : 'mt-4 p-3.5'}`}>
      ...
      {editing ? (
        <div className="mt-2 flex gap-2">
          ...
          />
          <button type="button" onClick={save} className="flex shrink-0 items-center gap-1 rounded-lg bg-orange-300 px-3 py-2 text-[11px] font-black text-[#15100b]"><Check size={14} /> ZAPISZ</button>
        </div>
